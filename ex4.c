...
int main()
{
    ...
    char first_word, first_word_text[] = "Hello! System Programming!";
    char second_word, second_word_text[] = "My name is KimJooEui";
    char third_word, third_word_text[] = "What's your name?";
    ...
    {
        fprintf(stderr, "터미널 속성을 설정할 수 없습니.\n");
    }
